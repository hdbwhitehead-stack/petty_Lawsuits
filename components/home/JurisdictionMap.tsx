...
const JURISDICTIONS = [
  {
    ...
    legalAid: 'LawAccess NSW — lawaccess.nsw.gov.au',
  },
  {
    code: 'VIC',
    tribunal: 'VCAT',
    ...
    legalAid: 'Victoria Legal Aid — legalaid.vic.gov.au',
  },
  {
    code: 'QLD',
    tribunal: 'QCAT',
    ...
    legalAid: 'Legal Aid Queensland — legalaid.qld.gov.au',
  },
  {
    code: 'WA',
    tribunal: 'SAT',
    ...
    legalAid: 'Legal Aid WA — legalaid.wa.gov.au',
  },
  {
    code: 'SA',
    tribunal: 'SACAT',
    ...
    legalAid: 'Legal Services Commission SA — lsc.sa.gov.au',
  },
  {
    code: 'TAS',
    tribunal: 'MRT',
    ...
    legalAid: 'Legal Aid Commission of Tasmania — legalaid.tas.gov.au',
  },
  {
    code: 'ACT',
    tribunal: 'ACAT',
    ...
    legalAid: 'Legal Aid ACT — legalaidact.org.au',
  },
  {
    code: 'NT',
    tribunal: 'NTCAT',
    ...
    legalAid: 'Northern Territory Legal Aid Commission — ntlac.nt.gov.au',
  },
]
      ...
      {active && (
        ...
        >
          ...
          <p className="text-sm">
            ...
            <span className="text-[var(--accent)] font-medium">{active.legalAid}</span>
          </p>
        </div>
      )}
    </div>
